...
public class LaunchVPN extends Activity {
    ...
    protected void startVpnFromIntent() {
        ...
        if (Intent.ACTION_MAIN.equals(action)) {
            ...
            if (profileToConnect == null) {
                VpnStatus.logError(R.string.ovpn_shortcut_profile_notfound);
    ...
    private void askForPW(final int type) {
        ...
        dialog.setTitle(getString(R.string.ovpn_pw_request_dialog_title, getString(type)));
        dialog.setMessage(getString(R.string.ovpn_pw_request_dialog_prompt, mSelectedProfile.mName));


        @SuppressLint("InflateParams") final View userpwlayout = getLayoutInflater().inflate(R.layout.userpass, null, false);

        if (type == R.string.ovpn_password) {
        ...
        dialog.setNegativeButton(android.R.string.cancel,
                new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        VpnStatus.updateStateString("USER_VPN_PASSWORD_CANCELLED", "", R.string.ovpn_state_user_vpn_password_cancelled,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == START_VPN_PROFILE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (needpw != 0) {
                    VpnStatus.updateStateString("USER_VPN_PASSWORD", "", R.string.ovpn_state_user_vpn_password,
                ...
                VpnStatus.updateStateString("USER_VPN_PERMISSION_CANCELLED", "", R.string.ovpn_state_user_vpn_permission_cancelled,
                        ConnectionStatus.LEVEL_NOTCONNECTED);
    ...
    void showConfigErrorDialog(int vpnok) {
        ...
        d.setTitle(R.string.ovpn_config_error_found);
        d.setMessage(vpnok);
    ...
    void launchVPN() {
        ...
        if (vpnok != R.string.ovpn_no_error_found) {
        ...
        if (intent != null) {
            VpnStatus.updateStateString("USER_VPN_PERMISSION", "", R.string.ovpn_state_user_vpn_permission,
                    ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT);
            // Start the query
            try {
